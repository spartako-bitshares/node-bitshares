...
This command is used only for convenince.
For security reason I _strongly_ suggest you to change ~/.Bitshares/config.json file and launch bitshares_client without params.
